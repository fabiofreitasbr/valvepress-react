    ...
    <>
      <header
        className={
          ...
          (namePath == "/" ? "bg-blue-900 " : " bg-blue-900 ") +
          menuFlutuante
        }
      >
          ...
          <div className="flex justify-between items-center h-full gap-2 md:gap-4 lg:gap-10">
            ...
            <nav className="items-center flex  ">
              <ul className="hidden md:flex items-center text-xs  xl:text-base  2xl:gap-8 uppercase font-normal lg:gap-4">
                ...
                <li className=" px-3 lg:px-0">
                  <Link
                    ...
                    className={
                      "text-white hover:text-orange-500" +
                      (namePath == "/quem-somos"
                        ? " flex border-b-2 py-4 border-orange-500"
                        : "")
                    }
                  >
                    Quem Somos
                ...
                <li
                  className="relative px-3 lg:px-0  text-center "
                ...
                >
                  <div className="flex flex-wrap items-center relative gap-1 ">
                    ...
                    >
                      <div className="w-auto lg:w-18 xl:w-auto">
                        Linhas de Produtos
                      </div>
                      <FontAwesomeIcon
                  ...
                  {menuProduct && (
                    <div
                      className="absolute z-20 left-0 mt-2 2xl:w-120 bg-white border-t-2  border-orange-500 grid grid-col 2xl:grid-cols-2 text-start"
                      onMouseLeave={() => setMenuProduct(false)}
                    >
                      <ul className="py-2">
                        <li>
                          <Link
                ...
                <li className="relative px-3 lg:px-0  text-center text-white">
                  <ul>
                    ...
                    {menuSegment && (
                      <div
                        className="absolute z-20 left-0 mt-2 2xl:w-120 bg-white border-t-2  border-orange-500 grid grid-col 2xl:grid-cols-2 text-start"
                        onMouseLeave={() => setMenuSegment(false)}
                      >
                        <ul className="py-2">
                          <li>
                            <Link
