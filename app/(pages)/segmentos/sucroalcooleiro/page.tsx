...
const Terminais = () => {
    return (
        <div className="relative">
            <HeaderTitle title="Sucroalcooleiro ou Sucroenergético" />
            <section className="py-10 lg:py-16 ">
                <div className="container mx-auto px-4 ">
                    <div className="block lg:flex lg:flex-row-reverse  ">
                        <div className="lg:w-3/6 flex justify-content items-center">
                            <Image src={Sucroalcooleiro} className="lg:w-2/3 w-1/2 sm:w-1/2 xl:w-1/2 mx-auto md:mb-6 mb-4 aspect-square object-cover rounded-full border-5 md:border-10 border-zinc-200" alt="" />
                        </div>
