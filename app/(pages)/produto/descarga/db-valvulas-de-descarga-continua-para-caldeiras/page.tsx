...
const contentModelo = {
    produtos: [
        {
            title: "DB – VÁLVULAS DE DESCARGA CONTÍNUA PARA CALDEIRAS.",
            text: "Para descarga contínua de sais e lixívias em caldeiras de vapor. Indicada, também, para evaporadores e similares, ou para ser aplicada como válvula reguladora e dosadora em outros equipamentos industriais.",
            img: Db,
        },
    ],
    ...
    modelos: [
        {
            title: "DB31",
            text: "Válvulas de descarga contínua para caldeiras,corpo em aço liga fundido",
        },
        {
            title: "DB51",
            text: "Válvula de descarga contínua para caldeiras,corpo em aço carbono fundido",
        },
        {
            title: "DB81",
            text: "Válvulas de descarga contínua para caldeiras,corpo em aço liga fundido",
...
export default function DescargaDB() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> DB – VÁLVULAS DE DESCARGA CONTÍNUA PARA CALDEIRAS </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da DB
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
