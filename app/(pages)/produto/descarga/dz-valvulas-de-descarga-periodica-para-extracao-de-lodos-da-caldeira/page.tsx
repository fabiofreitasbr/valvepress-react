...
const contentModelo = {
    produtos: [
        {
            title: "DZ-VÁLVULAS DE DESCARGA PERIÓDICA PARA EXTRAÇÃO DE LODOS DA CALDEIRA.",
    ...
    modelos: [
        {
            title: "DZ41",
            text: "Válvula de descarga periódica para extração de lodos da caldeira",
        },
        {
            title: "DZ45",
            text: "Válvula de descarga periódica para extração de lodos da caldeira",
...
export default function DescargaDZ() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> DZ-VÁLVULAS DE DESCARGA PERIÓDICA PARA EXTRAÇÃO DE LODOS DA CALDEIRA </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da DZ
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
