...
const contentModelo = {
    produtos: [
        {
            title: "GC – VISOR DE FLUXO COM SIFÃO E JANELA DUPLA",
            text: "Para controlar o fluxo do condensado a montante de purgadores e a jusante de superfícies de aquecimento em sistemas de vapor.",
            img: Gc,
        },
    ],
    ...
    modelos: [
        {
            title: "GC11",
            text: "Visor de fluxo com sifão e janela dupla,corpo em ferro fundido",
        },
        {
            title: "GC31",
            text: "Visor de fluxo com sifão e janela dupla,corpo em aço carbono fundido",
        },
    ],
}

export default function FluxoGC() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> GC – VISOR DE FLUXO COM SIFÃO E JANELA DUPLA </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da GC
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
