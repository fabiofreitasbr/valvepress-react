...
const contentModelo = {
    produtos: [
        {
            title: "GS – VISOR DE FLUXO PARA CONTROLE A JUSANTE DE PURGADORES, JANELA DUPLA, CRISTAL EM VIDRO TEMPERADO",
            text: "Para observar o deslocamento de qualquer fluido em uma tubulação. Instalado a jusante de purgadores, que descarregam para linha de retorno, possibilitam verificar se os mesmos estão funcionando.",
            img: Gs,
        },
    ],
    ...
    modelos: [
        {
            title: "GS11D",
            text: "Visor de fluxo para controle a jusante de purgadores,corpo em ferro fundido",
        },
        {
            title: "GS11S",
            text: "Visor de fluxo para controle a jusante de purgadores,corpo em ferro fundido",
...
export default function FiltroGS() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className="text-orange-500 uppercase"><a href="/tipos/visores-de-fluxo"> Visores de Fluxo</a></span>
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> GS – VISOR DE FLUXO PARA CONTROLE A JUSANTE DE PURGADORES, JANELA DUPLA, CRISTAL EM VIDRO TEMPERADO
                                    ...
                                    <div>
                                     ...
                                     {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da GS
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
