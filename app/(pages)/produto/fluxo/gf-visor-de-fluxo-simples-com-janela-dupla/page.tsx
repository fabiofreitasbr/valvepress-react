...
const contentModelo = {
    produtos: [
        {
            title: "GF – VISOR DE FLUXO SIMPLES COM JANELA DUPLA",
            text: "Para verificação das condições de fluxo no interior de tubulações, com fluidos líquidos e gasosos de pH até 10.",
            img: Gf,
        },
    ],
...
export default function FluxoGF() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> GF – VISOR DE FLUXO SIMPLES COM JANELA DUPLA</a></span>
                    </div>
                </div>
