...
const contentModelo = {
    produtos: [
        {
            title: "SP-VÁLVULA DE CONTROLE PARA CONTROLE DE VARIÁVEIS TAIS COMO PRESSÃO, TEMPERATURA, VAZÃO, NÍVEL ETC.",
            text: "Válvula de controle Para controle de variáveis tais como pressão, temperatura, vazão, nível etc. Próprias para operar em tubulações de líquidos, vapor e outros gases.",
            img: Sp,
        },
    ],
    ...
    modelos: [
        {
            title: "SP11K",
            text: "Válvula de controle, de 3-vias, corpo em ferro fundido",
        },
        {
            title: "SP15A",
            text: "Válvula de controle, tipo Globo, corpo em ferro fundido",
        },
        {
            title: "SP25A",
            text: "Válvula de controle, tipo Globo, corpo em aço carbono",
        },
        {
            title: "SP26A",
            text: "Válvula de controle, tipo Globo, corpo em aço inox",
        },
        {
            title: "SP33K",
            text: "Válvula de controle, de 3-vias, corpo em aço carbono",
        },
    ],
}
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da SA
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
