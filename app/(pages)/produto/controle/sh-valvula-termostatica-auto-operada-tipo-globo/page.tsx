...
const contentModelo = {
    produtos: [
        {
            title: "SH – VÁLVULA TERMOSTÁTICA AUTO-OPERADA TIPO GLOBO",
            text: "Válvula termostática auto-operada tipo globo,para controle de temperatura em sistemas.",
            img: Sh,
        },
    ],
    ...
    modelos: [
        {
            title: "SH11K",
            text: "Válvula termostática auto-operada tipo globo, 3-vias, corpo em ferro fundido SH - VÁLVULA",
        },
        {
            title: "SH16A",
            text: "Válvula termostática auto-operada tipo globo, corpo em ferro fundido",
        },
        {
            title: "SH26A",
            text: "Válvula termostática auto-operada tipo globo, corpo em aço carbono",
        },
        {
            title: "SH33K",
            text: "Válvula termostática auto-operada tipo globo, 3-vias, corpo em aço carbono",
        },
    ],
}

export default function ControleSH() {
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da SH
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
