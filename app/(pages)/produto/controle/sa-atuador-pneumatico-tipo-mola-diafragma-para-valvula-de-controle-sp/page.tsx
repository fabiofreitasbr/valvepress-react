...
const contentModelo = {
    ...
    modelos: [
        {
            title: "SA30",
            text: "Atuador pneumático tipo mola-diafragma para válvula de controle SP, curso 15 mm",
        },
        {
            title: "SA50",
            text: "Atuador pneumático tipo mola-diafragma para válvula de controle SP, curso 15 mm",
        ...
        {
            title: "SA70",
            text: "Atuador pneumático tipo mola-diafragma para válvula de controle SP, curso 15 e 30 mm",
        },
    ],
}

export default function ControleSA() {
