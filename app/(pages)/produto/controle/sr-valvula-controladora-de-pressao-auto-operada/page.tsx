...
const contentModelo = {
    produtos: [
        {
            title:
                "SR – VÁLVULA CONTROLADORA DE PRESSÃO AUTO-OPERADA",
            text: "Utilizadas em estações de bombeamento, geradores de vapor, trocadores de calor e outras instalações nas destilarias, refinarias indústrias químicas, petroquímicas, etc. Operam com vapor, água ou outros fluidos líquidos ou gasosos.",
            img: Sr,
        },
    ],
    ...
    modelos: [
        {
            title: "SR15E",
            text: "Válvula control.reguladora de pressão auto-operada, corpo em ferro fundido",
        },
        {
            title: "SR15R",
            text: "Válvula control.redutora de pressão auto-operada, corpo em ferro fundido",
        },
        {
            title: "SR25E",
            text: "Válvula control.reguladora de pressão auto-operada, corpo em aço carbono",
        },
        {
            title: "SR25R",
            text: "Válvula control.redutora de pressão auto-operada, corpo em aço carbono",
        },
    ],
}

export default function ControleSR() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className="text-orange-500 uppercase"><a href="/tipos/valvulas-de-controle"> Válvulas de Controle </a></span>
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> SR – VÁLVULA CONTROLADORA DE PRESSÃO AUTO-OPERADA </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da SR
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
