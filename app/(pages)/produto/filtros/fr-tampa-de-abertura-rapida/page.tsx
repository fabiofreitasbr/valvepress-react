...
const contentModelo = {
    produtos: [
        {
            title:
                "FR – TAMPA DE ABERTURA RÁPIDA",
            text: "Desenvolvida para acesso rápido em lançadores/receptores de PIG, aplica-se também a filtro e autoclave dos diversos segmentos industriais. São oferecidas nas versões vertical, horizontal e retrofit.",
            img: Fr,
        },
    ],
    ...
    modelos: [
        {
            title: "FR",
            text: "Tampa de Abertura Rápida , corpo em aço carbono fundido",
        },
    ],
}

export default function FiltroFR() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> FR – TAMPA DE ABERTURA RÁPIDA </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da FR
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
