...
const contentModelo = {
    produtos: [
        {
            title: "FY – FILTRO TIPO “Y”",
            text: "Filtro tipo “Y” Para filtrar toda espécie de fluídos líquidos ou gasosos em tubulações industriais.",
            img: Fy,
        },
    ],
    ...
    modelos: [
        {
            title: "FY11",
            text: "Filtro tipo “Y”,corpo em ferro fundido",
        },
        {
            title: "FY12",
            text: "Filtro tipo “Y”, corpo em latão",
        },
        {
            title: "FY33",
            text: "Filtro tipo “Y”, corpo em aço carbono forjado ( até 1″) e em aço carbono fundido",
        },
        {
            title: "FY35",
            text: "Filtro para tubulação tipo “Y”,corpo em aço carbono",
        },
    ],
}

export default function FiltroFY() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> FY – FILTRO TIPO “Y” </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da FC
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
