...
const contentModelo = {
    produtos: [
        {
            title: "FS – SEPARADOR CENTRÍFUGO DE PARTÍCULAS",
            text: "Para eliminar condensado ou gotículas em suspensão, assim como outras impurezas, em instalações de vapor, ar comprimido ou outros gases. São aplicados tanto em instalações terrestres, quanto marítimas.",
            img: Fs,
        },
    ],
    ...
    modelos: [
        {
            title: "FS11",
            text: "Separador centrífugo de partículas,corpo em ferro fundido",
        },
        {
            title: "FS13",
            text: "Separador centrífugo de partículas, corpo em aço carbono",
        },
        {
            title: "FS33",
            text: "Separador centrífugo de partículas ,corpo em aço carbono",
...
export default function FiltroFS() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className="text-orange-500 uppercase"><a href="/tipos/filtros-para-tubulacoes"> Filtros para Tubulações </a></span>
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> FS – SEPARADOR CENTRÍFUGO DE PARTÍCULAS </a></span>
                    </div>
                </div>
                <div className="container mx-auto px-4">
                    {contentModelo.produtos.map((produto, index) => (
                        <div className="flex flex-wrap py-4" key={index}>
                                    ...
                                    <div>
                                     ...
                                     {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da FS
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
