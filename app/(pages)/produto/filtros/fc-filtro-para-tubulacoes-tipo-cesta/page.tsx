...
const contentModelo = {
    produtos: [
        {
            title:
                "FC – FILTRO PARA TUBULAÇÕES TIPO CESTA",
            text: "Para filtragem de qualquer fluídos em tubulações industriais.",
            img: Fc,
        },
    ],
    ...
    modelos: [
        {
            title: "FC33",
            text: "Filtro para tubulações tipo cesta,corpo em aço carbono",
        },
        {
            title: "FC11",
            text: "Filtro para tubulação tipo cesta,aço carbono laminado",
        },
    ],
}

export default function FiltroFC() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> FC – FILTRO PARA TUBULAÇÕES TIPO CESTA </a></span>
                    </div>
                </div>
