...
const contentModelo = {
    produtos: [
        {
            title: "HF – VÁLVULA DE SEGURANÇA E ALÍVIO FLANGEADA COM CASTELO FECHADO",
    ...
    modelos: [
        ...
        {
            title: "HF14",
            text: "Válvula de segurança e alívio flangeada, corpo em aço inox fundido.",
        },
        {
            title: "HF16",
            text: "Válvula de segurança e alívio flangeada com castelo fechado, corpo em aço liga fundido.",
        },
        {
            title: "HF33",
            text: "Válvula de segurança e alívio flangeada com castelo fechado,corpo em aço carbono fundido.",
        },
        {
            title: "HF34",
            text: "Válvula de segurança e alívio flangeada com castelo fechado,corpo em aço inox fundido.",
        },
        {
            title: "HF36",
            text: "Válvula de segurança e alívio flangeada com castelo fechado,corpo em aço liga fundido.",
...
export default function SegurancaHF() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> HF – VÁLVULA DE SEGURANÇA E ALÍVIO FLANGEADA COM CASTELO FECHADO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da HF
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
