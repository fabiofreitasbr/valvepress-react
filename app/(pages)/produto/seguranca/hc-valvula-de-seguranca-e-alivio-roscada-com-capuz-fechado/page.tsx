...
const contentModelo = {
    produtos: [
        {
            title: "HC – VÁLVULA DE SEGURANÇA E ALÍVIO ROSCADA COM CAPUZ FECHADO",
            text: "Utilizadas para proteger equipamentos e instalações industriais contra sobrepressões de ar, água, vapor, gases, fluidos viscosos e produtos químicos em geral.",
            img: Hc,
        },
    ],
    ...
    modelos: [
        {
            title: "HC63",
            text: "Válvula de segurança e alívio roscada,corpo em aço carbono fundido.",
        },
        {
            title: "HC64",
            text: "Válvula de segurança e alívio roscada com capuz",
        },
        {
            title: "HC73",
            text: "Válvula de segurança e alívio roscada, corpo em aço carbono fundido.",
        ...
        {
            title: "HC74",
            text: "Válvula de segurança e alívio roscada,corpo em aço liga fundido.",
        },
    ],
}

export default function SegurancaHC() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> HC – VÁLVULA DE SEGURANÇA E ALÍVIO ROSCADA COM CAPUZ FECHADO </a></span>
                    </div>
                </div>
