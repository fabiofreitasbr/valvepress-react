...
const contentModelo = {
    produtos: [
        {
            title: "LD – PROTETOR CONTRA DETONAÇÃO/EXPLOSÃO EM TUBULAÇÃO",
            text: "Protege contra a propagação de chamas em casos de explosão e detonação de líquidos ou gases inflamáveis. São instalados em tubulações à montante do equipamento a ser protegido.",
            img: Ld,
        },
    ],
    ...
    modelos: [
        {
            title: "LD11",
            text: "Protetor contra detonação/explosão,corpo em ferro nodular",
        },
        {
            title: "LD12",
            text: "Protetor contra detonação/explosão em tubulação,corpo em ferro nodular",
        },
        {
            title: "LD17",
            text: "Protetor contra detonação/explosão em tubulação, corpo em aço carbono",
        },
        {
            title: "LD25",
            text: "Protetor contra detonação/explosão em tubulação, em aço inox",
        },
    ],
}

export default function ValculaLD() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> LD – PROTETOR CONTRA DETONAÇÃO/EXPLOSÃO EM TUBULAÇÃO </a></span>
                    </div>
                </div>
