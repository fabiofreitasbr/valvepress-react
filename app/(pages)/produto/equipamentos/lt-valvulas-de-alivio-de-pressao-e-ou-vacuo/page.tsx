...
const contentModelo = {
    produtos: [
        {
            title: "LT – VÁLVULAS DE ALÍVIO DE PRESSÃO E/OU VÁCUO",
            text: "Instaladas em tubulações de gás inerte ou instalações de ar seco. São adequadas para manter a pressão e/ou vácuo no interior de tanques, tubulações e outros equipamentos, conforme a calibração determinada.",
            img: Lt,
        },
    ],
    ...
    modelos: [
        {
            title: "LT12",
            text: "Válvulas de alívio de pressão e/ou vácuo, sede dupla, corpo em ferro nodular",
        },
        {
            title: "LT13",
            text: "Válvulas de alívio de pressão e/ou vácuo, 3 vias,corpo em ferro nodular",
        },
        {
            title: "LT17",
            text: "Válvulas de alívio de pressão e/ou vácuo, corpo em alumínio",
        },
        {
            title: "LT18",
            text: "Válvulas de alívio de pressão e/ou vácuo, corpo em alumínio",
        ...
        {
            title: "LT19",
            text: "Válvulas de alívio de pressão e/ou vácuo, 3 vias,corpo em aço inox",
        },
        {
            title: "LT25D",
            text: "Válvulas de alívio de pressão e/ou vácuo, sede dupla,corpo em aço inox",
        },
        {
            title: "LT25T",
            text: "Válvulas de alívio de pressão e/ou vácuo, 3 vias, corpo em aço inox",
        ...
        {
            title: "LT25U",
            text: "Válvulas de alívio de pressão e/ou vácuo, sede única,corpo em aço inox",
        },
        {
            title: "LT11",
            text: "Válvulas de alívio de pressão e/ou vácuo, sede única, corpo em ferro nodular",
        },
    ],
}

export default function ValculaLT() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> LT – VÁLVULAS DE ALÍVIO DE PRESSÃO E/OU VÁCUO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da LT
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
