...
const contentModelo = {
    produtos: [
        {
            title: "LE – PROTETOR CONTRA EXPLOSÃO EM TUBULAÇÃO",
            text: "Instalados em tubulações e instalações, de produção e de transferência, de líquidos e gases inflamáveis em que surgem perigos de retrocesso de chamas de queimadores ou a propagação de explosões.",
            img: Le,
        },
    ],
    ...
    modelos: [
        {
            title: "LE16",
            text: "rotetor contra explosão em tubulação, corpo em ferro nodular",
        },
        {
            title: "LE16F",
            text: "Protetor contra explosão em tubulação,corpo em ferro fundido",
        },
        {
            title: "LE16W",
            text: "Conjunto abafador para montagem entre flanges. Armações em aço carbono e colmeias em aço INOX.",
        },
        {
            title: "LE19",
            text: "Protetor contra explosão em tubulação, corpo em aço carbono",
        },
        {
            title: "LE25",
            text: "Protetor contra explosão em tubulação, corpo em aço inox",
        },
    ],
}

export default function ValculaLE() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> LE – PROTETOR CONTRA EXPLOSÃO EM TUBULAÇÃO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                   ...
                                   {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da LE
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
