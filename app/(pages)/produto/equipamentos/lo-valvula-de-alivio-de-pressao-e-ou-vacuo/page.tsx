...
const contentModelo = {
    produtos: [
        {
            title: "LO – VÁLVULA DE ALÍVIO DE PRESSÃO E/OU VÁCUO",
            text: "Instaladas nos tubos de ventilação de tanques de armazenamento atmosféricos. Mantem a pressão e o vácuo dentro do tanque, conforme a calibração de pressão determinada, diminuindo a perda de produto por evaporação e a contaminação do ambiente.",
            img: Lo,
        },
    ],
    ...
    modelos: [
        {
            title: "LO16",
            text: "Válvula de alívio de pressão e/ou vácuo,corpo em ferro fundido nodular",
        },
        {
            title: "LO16F",
            text: "Válvula de alívio de pressão e/ou vácuo,corpo em ferro fundido",
        },
        {
            title: "LO19",
            text: "Válvula de alívio de pressão e/ou vácuo, corpo em aluminio",
        },
        {
            title: "LO25",
            text: "Válvula de alívio de pressão e/ou vácuo, corpo em aço inox",
        },
    ],
}

export default function ValculaLO() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> LO – VÁLVULA DE ALÍVIO DE PRESSÃO E/OU VÁCUO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da LO
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
