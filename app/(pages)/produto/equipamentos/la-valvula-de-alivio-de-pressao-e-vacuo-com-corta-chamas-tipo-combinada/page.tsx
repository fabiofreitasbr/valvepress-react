...
import La11 from "@/public/img/produtos/equipamentos-seguranca/la11.png";
...
const contentModelo = {
    produtos: [
        {
            title:
                "LA – VÁLVULA DE ALÍVIO DE PRESSÃO E VÁCUO COM CORTA-CHAMAS TIPO COMBINADA",
            text: "Indicadas para proteger respiros de tanques de armazenagem de produtos inflamáveis, contra explosão externa. Além disso, reduzem as perdas do produto por evaporação.",
            img: La11,
        },
    ],
    ...
    modelos: [
        {
            title: "LA16",
            text: "álvula de alívio de pressão e vácuo com corta-chamas tipo combinada, material do corpo em ferro nodular.",
        },
        {
            title: "LA16F",
            text: "Válvulas de alívio de pressão e vácuo com corta-chamas tipo combinada, corpo em ferro cinzento.",
        },
        {
            title: "LA19",
            text: "Válvulas de alívio de pressão e vácuo com corta-chamas tipo combinada,corpo em alumínio.",
        },
    ],
}

export default function ValculaLA() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> La - Válvula de Alívio de Pressão e Vácuo com Corta-chamas tipo combinada </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da LA
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
