...
const contentModelo = {
    produtos: [
        {
            title:
                "TF – PURGADOR DE BOIA PARA VAPOR, CORPO EM AÇO CARBONO FUNDIDO",
            text: "Para purgação e desaeração de linhas de vapor e quaisquer trocadores de calor. Especialmente aplicável em circuitos regulados e para controle de nível.",
            img: Tf,
        },
    ],
    ...
    modelos: [
        {
            title: "TF11",
            text: "Purgador de boia para vapor,corpo em ferro fundido",
        },
        {
            title: "TF12",
            text: "Purgador de bóia para vapor,corpo em aço carbono fundido.",
        },
        {
            title: "TF33",
            text: "Purgador de boia para vapor,corpo em aço carbono fundido",
        },
        {
            title: "TF35",
            text: "Purgador de boia para vapor,corpo em aço inoxidável fundido",
        },
    ],
}

export default function PurgadoresTF() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className="text-orange-500 uppercase"><a href="/tipos/purgadores-para-vapor-e-ar-comprimido"> Purgadores para Vapor e Ar Comprimido </a></span>
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TF – PURGADOR DE BOIA PARA VAPOR, CORPO EM AÇO CARBONO FUNDIDO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TF
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
