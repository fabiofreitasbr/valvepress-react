...
const contentModelo = {
    produtos: [
        {
            title:
                "TM – PURGADOR TÉRMICO PARA VAPOR COM REGULADOR TÉRMICO MONOBLOCO (RTM)",
            text: "Para drenagem e desaeração de linhas de vapor, autoclaves, máquinas para lavagem a seco, cilindros secadores, etc.",
            img: Tm,
        },
    ],
    ...
    modelos: [
        {
            title: "TM23",
            text: "Purgador Térmico para vapor, corpo em aço carbono forjado",
        },
        {
            title: "TM23U",
            text: "Purgador Térmico para vapor com conexão universal, corpo em aço carbono.",
        },
        {
            title: "TM23Y",
            text: "Purgador Térmico para vapor,corpo em aço carbono forjado.",
        ...
        {
            title: "TM24",
            text: "Purgador Térmico para vapor, corpo em aço inoxidável tipo 420",
        },
    ],
}

export default function PurgadoresTM() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TM – PURGADOR TÉRMICO PARA VAPOR COM REGULADOR TÉRMICO MONOBLOCO (RTM) </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TM
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
