...
const contentModelo = {
    produtos: [
        {
            title:
                "TN – INDICADO PARA PURGADORES COM DESCARGA PARA ATMOSFERA QUE SEJAM DO TIPO INTERMITENTE",
            text: "Indicado para purgadores com descarga para atmosfera que sejam do tipo intermitente, quando deseja-se regular o nível de ruído em uma planta industrial.",
            img: Tn,
        },
    ],
    ...
    modelos: [
        {
            title: "TN35",
            text: "Silenciador para descarga de purgadores",
        },
    ],
}

export default function PurgadoresTN() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TN – INDICADO PARA PURGADORES COM DESCARGA PARA ATMOSFERA QUE SEJAM DO TIPO INTERMITENTE </a></span>
                    </div>
                </div>
