...
const contentModelo = {
    produtos: [
        {
            title:
                "TI – PURGADORES DE BALDE INVERTIDO",
            text: "Recomendados para serviços onde são exigidas eficiência e durabilidade, sem a retenção de condensado. Operam totalmente aberta ou totalmente fechada e são portanto mais solicitadas para serviços de média a alta pressão de vapor.",
            img: Ti,
        },
    ],
    ...
    modelos: [
        {
            title: "TI35U",
            text: "PURGADORES DE BALDE INVERTIDO",
        },
    ],
}

export default function PurgadoresTI() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TI – PURGADORES DE BALDE INVERTIDO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TI
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
