...
const contentModelo = {
    produtos: [
        {
            title:
                "TC – PURGADOR TERMODINÂMICO PARA VAPOR",
            text: "Para drenagem do condensado em linhas de vapor saturado e trocadores de calor onde o funcionamento intermitente, inerente aos purgadores termodinâmicos, não prejudique o desempenho do sistema.",
            img: Tc,
        },
    ],
    ...
    modelos: [
        {
            title: "TC54C",
            text: "Purgador termodinâmico para vapor,corpo em aço inoxidavel",
        },
        {
            title: "TC54N",
            text: "Purgador termodinâmico para vapor,corpo em aço inoxidável",
        },
        {
            title: "TC54U",
            text: "Purgador termodinâmico para vapor,corpo em aço inoxidável",
...
export default function PurgadoresTC() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className="text-black uppercase"><a href=""> TC – PURGADOR TERMODINÂMICO PARA VAPOR </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                   ...
                                   {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TC
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
