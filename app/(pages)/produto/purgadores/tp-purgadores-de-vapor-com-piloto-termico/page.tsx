...
const contentModelo = {
    produtos: [
        {
            title:
                "TP – PURGADORES DE VAPOR COM PILOTO TÉRMICO",
            text: "Para purgação e desaeração de quaisquer trocadores de calor. Especialmente desenvolvido para vazões extremamente altas com baixas e médias pressões, como por exemplo, em cozinhadores, aquecedores, evaporadores, etc.",
            img: Tp,
        },
    ],
    ...
    modelos: [
        {
            title: "TP11",
            text: "Purgador de vapor com piloto térmico,corpo em ferro fundido",
        },
        {
            title: "TP21",
            text: "Purgador de vapor com piloto térmico,corpo em aço carbono fundido",
        },
    ],
}

export default function PurgadoresTP() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TP – PURGADORES DE VAPOR COM PILOTO TÉRMICO </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TP
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
