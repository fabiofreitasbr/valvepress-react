...
const contentModelo = {
    produtos: [
        {
            title:
                "TB – PURGADOR DE LÂMINAS BIMETÁLICAS",
            text: "Para purgação e desaeração de linhas de vapor saturado ou superaquecido e de trocadores de calor. Para baixas, médias ou altas pressões.",
            img: Tb,
        },
    ],
    ...
    modelos: [
        {
            title: "TB01Y",
            text: "Purgador de lâminas bimetálicas,corpo aço carbono forjado",
        },
        {
            title: "TB25",
            text: "Purgador de lâminas bimetálicas,corpo em aço carbono fundido",
        },
        {
            title: "TB51",
            text: "Purgador de lâminas bimetálicas,corpo em aço liga fundido",
        },
        {
            title: "TB52",
            text: "Purgador de lâminas bimetálicas,corpo em aço liga fundido",
...
export default function PurgadoresTB() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TB – PURGADOR DE LÂMINAS BIMETÁLICAS </a></span>
                    </div>
                </div>
                                    ...
                                    <div>
                                     ...
                                     {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TB
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
