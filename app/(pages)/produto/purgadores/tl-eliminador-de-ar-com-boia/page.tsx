...
const contentModelo = {
    produtos: [
        {
            title:
                "TL – ELIMINADOR DE AR COM BÓIA",
            text: "Para a desaeração de linhas de líquidos, através de mecanismo de bóia que modula a abertura da sede, com vistas à eliminação de bolsões de ar que comprometem a circulação de líquido.",
            img: Tl,
        },
    ],
    ...
    modelos: [
        {
            title: "TL11",
            text: "ELIMINADOR DE AR COM BÓIA",
        },
    ],
}

export default function PurgadoresTL() {
            ...
            <section className="py-4">
                <div className="breadcrumb my-4">
                    <div className="container mx-auto px-4 uppercase text-sm">
                        ...
                        <span>&gt;</span>
                        <span className={textColor ? "text-orange-500" : "text-black"}><a href=""> TL – ELIMINADOR DE AR COM BÓIA </a></span>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {/*<button type="button" className="bg-blue-900 hover:bg-blue-950 mx-auto md:mx-0 transition text-white font-medium rounded-full my-4 py-3 px-4 md:px-10 xl:px-16 block text-xs sm:text-base lg:text-lg uppercase">
                                        <div className="flex gap-2 items-center justify-center">
                                            <FontAwesomeIcon icon={faDownload} className=" w-5 h-5" /> Download do Prospecto em PDF da TL
                                        </div></button> */}
                                </div>
                            </div>
                        </div>
